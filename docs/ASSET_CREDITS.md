...
| `linh_sung_1x_0.png` · `linh_sung_2x_0.png` | Mẻ lính đời súng + hiện đại, Phase 10B. Người, ngựa, kiếm, động tác: Quaternius như `linh_co`, <https://quaternius.com>. **Icosa Gallery** (<https://icosa.gallery>, xem `docs/KHO_ICOSA.md`): xe tăng "Tank" <https://icosa.gallery/view/41Tq_Kf0Tui> · đại bác "Rev war cannon" <https://icosa.gallery/view/7pfX_iKfJyH> · súng "low poly bolt rifle" <https://icosa.gallery/view/epemCvhKIb0> | Quaternius (Tomás Laulhé) · **Nico _** (xe tăng) · **Michael Pretz** (đại bác) · **Hell Houndz Productions** (súng) | CC0 1.0 (Quaternius) · **CC-BY 3.0** (ba model Icosa) | 26/09/2026 |
